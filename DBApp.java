...
public class DBApp {
    ...
    public void insertIntoTable(String strTableName,
        ...
        //the following implementation assuems that there is no B+ tree index on the column
        if (directory.exists() && directory.isDirectory()) {
            System.out.println("table exists!");
            //if the table directory has only 1 directory it means that it doesn't
            //have any records in the table
    ...
    DBAppException("not implemented yet");
}
